    ...
    <AccountShell title="تسجيل الخروج وحذف الحساب" description="حذف الحساب نهائي ولا يترتب عليه استرداد أي مبالغ مدفوعة.">
      <div className="grid gap-5">
        ...
        <section className="rounded-lg border border-red-200 bg-white p-5">
          ...
          <button disabled={!confirmDelete || !password || !typedEmail} onClick={removeAccount} className="mt-4 rounded-md bg-red-700 px-4 py-2 font-semibold text-white disabled:opacity-50">
            حذف حساب {user?.email}
          </button>
        </section>
      </div>
